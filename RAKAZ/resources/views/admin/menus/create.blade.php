...
@section('title', __('labels.menus.add_new'))

@section('content')
<div class="page-header">
    <div class="page-header-content">
        <h1 class="page-title">{{ __('labels.menus.add_new') }}</h1>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="image_title_ar" class="form-control @error('image_title_ar') is-invalid @enderror" value="{{ old('image_title_ar') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="image_title_en" class="form-control @error('image_title_en') is-invalid @enderror" value="{{ old('image_title_en') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="image_description_ar" class="form-control @error('image_description_ar') is-invalid @enderror" rows="2">{{ old('image_description_ar') }}</textarea>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="image_description_en" class="form-control @error('image_description_en') is-invalid @enderror" rows="2">{{ old('image_description_en') }}</textarea>
