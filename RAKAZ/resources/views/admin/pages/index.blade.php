        ...
        <table class="data-table">
            <thead>
                <tr>
                    <th>#</th>
                    <th>
                        <span class="ar-text">الصورة</span>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($page->image)
                            <img src="{{ asset($page->image) }}" alt="{{ $page->title_ar }}" style="width: 50px; height: 50px; object-fit: cover; border-radius: 8px;">
                        @else
                            <div style="width: 50px; height: 50px; background: #e2e8f0; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                <svg width="20" height="20" fill="none" stroke="#a0aec0" viewBox="0 0 24 24">
