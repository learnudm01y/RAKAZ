...
<div class="content-header">
    <div class="content-header-left" style="display: flex; align-items: center; gap: 1rem;">
        ...
        <h1 class="page-title" style="margin: 0;">
            <span class="ar-text">تعديل الصفحة: {{ $page->title_ar }}</span>
            <span class="en-text">Edit Page: {{ $page->title_en }}</span>
        </h1>
...
<form method="POST" action="{{ route('admin.pages.update', $page) }}" class="page-form" enctype="multipart/form-data" id="pageForm">
    @csrf
    @method('PUT')
    ...
    <div class="card" style="margin-bottom: 1.5rem;">
        ...
        <div class="card-body">
            <div class="image-upload-wrapper {{ $page->image ? 'has-image' : '' }}" id="imageUploadWrapper" onclick="document.getElementById('imageInput').click()">
                <img src="{{ $page->image ? asset($page->image) : '' }}" alt="Preview" class="image-preview {{ $page->image ? 'show' : '' }}" id="imagePreview">
                <div class="upload-placeholder" id="uploadPlaceholder" style="{{ $page->image ? 'display: none;' : '' }}">
            ...
            <button type="button" class="remove-image-btn" id="removeImageBtn" style="{{ $page->image ? 'display: inline-block;' : 'display: none;' }}" onclick="removeImage(event)">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        name="content_ar"
                        style="display: none;"
                    >{{ old('content_ar', $page->content_ar) }}</textarea>
                    @error('content_ar')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        maxlength="255"
                    >{{ old('meta_description_ar', $page->meta_description_ar) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('meta_keywords_ar', $page->meta_keywords_ar) }}"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        maxlength="255"
                    >{{ old('meta_description_en', $page->meta_description_en) }}</textarea>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-row" style="grid-template-columns: repeat(2, 1fr);">
                <input type="hidden" id="slug" name="slug" value="{{ old('slug', $page->slug) }}">
                <div class="form-group">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Auto-update slug when English title changes
