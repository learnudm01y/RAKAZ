...
<div class="content-header">
    <div class="content-header-left">
        <h1 class="page-title">
            <span class="ar-text">تعديل الصفحة</span>
            <span class="en-text">Edit Page</span>
        </h1>
    </div>
...
<form method="POST" action="{{ route('admin.pages.update', $page) }}" class="page-form">
    @csrf
    @method('PUT')
    ...
    <div class="form-actions">
        <button type="submit" class="btn btn-primary btn-lg">
            ...
            <span class="ar-text">تحديث الصفحة</span>
            <span class="en-text">Update Page</span>
        </button>
