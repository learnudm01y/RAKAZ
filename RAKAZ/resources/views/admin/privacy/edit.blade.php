...
@section('page-title')
    <span class="ar-text">تعديل سياسة الخصوصية</span>
    <span class="en-text">Edit Privacy Policy</span>
@endsection
    ...
    <div class="editor-panel">
        <form id="privacyForm">
            ...
            <div class="lang-content active" id="ar-content">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="hero_title_ar" class="form-control" value="{{ $page->hero_title_ar ?? 'سياسة الخصوصية' }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="hero_subtitle_ar" class="form-control" rows="2">{{ $page->hero_subtitle_ar ?? 'آخر تحديث: 3 ديسمبر 2025' }}</textarea>
                        </div>
                    </div>
                </div>

                <!-- Main Content Section AR -->
                <div class="form-section">
                    <div class="form-section-title">
                        <span class="ar-text"><i class="fa-solid fa-file-lines"></i> محتوى سياسة الخصوصية الكامل</span>
                        <span class="en-text"><i class="fa-solid fa-file-lines"></i> Full Privacy Policy Content</span>
                    </div>

                    <div class="form-group">
                        <label>
                            <span class="ar-text">المحتوى الكامل (جميع الأقسام)</span>
                            <span class="en-text">Full Content (All Sections)</span>
                        </label>
                        <div id="editor_content_ar" class="quill-editor"></div>
                        <textarea name="content_ar" style="display:none;">{{ $page->content_ar ?? '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    <div class="form-section-title">
                        <span class="ar-text"><i class="fa-solid fa-magnifying-glass"></i> تحسين محركات البحث (SEO)</span>
                        <span class="en-text"><i class="fa-solid fa-magnifying-glass"></i> SEO Optimization</span>
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <label>
                                <span class="ar-text">وصف الميتا</span>
                                <span class="en-text">Meta Description</span>
                            </label>
                            <textarea name="meta_description_ar" class="form-control" rows="3">{{ $page->meta_description_ar ?? '' }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>
                                <span class="ar-text">الكلمات المفتاحية</span>
                                <span class="en-text">Meta Keywords</span>
                            </label>
                            <input type="text" name="meta_keywords_ar" class="form-control" value="{{ $page->meta_keywords_ar ?? '' }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lang-content" id="en-content">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="hero_title_en" class="form-control" value="{{ $page->hero_title_en ?? 'Privacy Policy' }}">
                        </div>

                        <div class="form-group">
                            <label><span class="ar-text">النص الفرعي</span><span class="en-text">Hero Subtitle</span></label>
                            <textarea name="hero_subtitle_en" class="form-control" rows="2">{{ $page->hero_subtitle_en ?? 'Last updated: December 3, 2025' }}</textarea>
                        </div>
                    </div>
                </div>

                <!-- Main Content Section EN -->
                <div class="form-section">
                    <div class="form-section-title">
                        <i class="fa-solid fa-file-lines"></i> <span class="ar-text">المحتوى الرئيسي</span><span class="en-text">Full Privacy Policy Content</span>
                    </div>

                    <div class="form-group">
                        <label><span class="ar-text">محتوى سياسة الخصوصية</span><span class="en-text">Full Content (All Sections)</span></label>
                        <div id="editor_content_en" class="quill-editor ltr-editor"></div>
                        <textarea name="content_en" style="display:none;">{{ $page->content_en ?? '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    <div class="form-section-title">
                        <i class="fa-solid fa-magnifying-glass"></i> <span class="ar-text">معلومات SEO</span><span class="en-text">SEO Optimization</span>
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <label><span class="ar-text">وصف الصفحة (SEO)</span><span class="en-text">Meta Description</span></label>
                            <textarea name="meta_description_en" class="form-control" rows="3">{{ $page->meta_description_en ?? '' }}</textarea>
                        </div>

                        <div class="form-group">
                            <label><span class="ar-text">الكلمات المفتاحية</span><span class="en-text">Meta Keywords</span></label>
                            <input type="text" name="meta_keywords_en" class="form-control" value="{{ $page->meta_keywords_en ?? '' }}">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="preview-panel" id="previewPanel">
    <div class="preview-header">
        ...
        <div class="preview-controls">
            ...
            <a href="{{ route('privacy.policy') }}" target="_blank" class="btn btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.875rem;">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="preview-frame-container">
        <iframe id="previewFrame" class="preview-frame desktop" src="{{ route('privacy.policy') }}"></iframe>
    </div>
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const contentArContent = document.querySelector('textarea[name="content_ar"]').value;
        if (contentArContent) {
            quillEditors.content_ar.root.innerHTML = contentArContent;
        }

        // English Main Content Editor
        const editorContentEnElement = document.querySelector('#editor_content_en');
        editorContentEnElement.parentElement.classList.add('ltr-editor');
        ...
        const contentEnContent = document.querySelector('textarea[name="content_en"]').value;
        if (contentEnContent) {
            quillEditors.content_en.root.innerHTML = contentEnContent;
        }
    });
    ...
    document.getElementById('privacyForm').addEventListener('submit', async function(e) {
        ...
        document.querySelector('textarea[name="content_ar"]').value = quillEditors.content_ar.root.innerHTML;
        document.querySelector('textarea[name="content_en"]').value = quillEditors.content_en.root.innerHTML;
        ...
        try {
            const response = await fetch('{{ route("admin.privacy.update") }}', {
                method: 'POST',
                headers: {
