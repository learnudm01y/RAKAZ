...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Note: Add to Bag functionality is now handled individually in each page
    // (shop.blade.php, wishlist.blade.php, etc.) to allow for custom modal behavior

    // Note: Remove from Wishlist functionality is now handled in wishlist.blade.php
    // with SweetAlert confirmation dialog instead of native confirm()
